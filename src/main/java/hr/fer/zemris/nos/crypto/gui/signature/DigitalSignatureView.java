 ...
 * crypto
 */
public class DigitalSignatureView extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        URL url = getClass().getClassLoader().getResource("digital_signature_view.fxml");

        FXMLLoader loader = new FXMLLoader(url);
        loader.setClassLoader(getClass().getClassLoader());
        Parent root = loader.load();

        DigitalSignatureViewController controller = loader.getController();
