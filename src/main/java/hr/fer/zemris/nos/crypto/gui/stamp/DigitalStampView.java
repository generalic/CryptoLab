 ...
 * crypto
 */
public class DigitalStampView extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        URL url = getClass().getClassLoader().getResource("digital_stamp_view.fxml");

        FXMLLoader loader = new FXMLLoader(url);
        loader.setClassLoader(getClass().getClassLoader());
        Parent root = loader.load();

        DigitalStampViewController controller = loader.getController();
        controller.setMainStage(primaryStage);

        primaryStage.setTitle("Digital Stamp");
